...
const Sidebar = () => {
  ...
  return (
    <div className=" sticky top-0 h-[100vh] pb-10 flex bg-blue-200">
        ...
        <div clasName="relative">
          ...
          <div className="absolute bottom-20 left-14  w-[70%]">
            {/* {showDropdown && (
              ...
              className="w-full py-2 text-base px-4 border font-bold cursor-pointer transition duration-300 ease-in-out hover:bg-white hover:text-black hover:shadow-m"
            >
              Log out
            </p>
